...
def app_client(mock_registry) -> Generator[TestClient, None, None]:
    ...
    with (
        ...
        patch("hiring.router.save_prediction",          new=_noop_save_prediction),
        patch("loan.router.save_prediction",            new=_noop_save_prediction),
        patch("social.router.save_prediction",          new=_noop_save_prediction),
        patch("hiring.router.get_recent_predictions",   new=_noop_get_recent),
        patch("loan.router.get_recent_predictions",     new=_noop_get_recent),
        patch("social.router.get_recent_predictions",   new=_noop_get_recent),
